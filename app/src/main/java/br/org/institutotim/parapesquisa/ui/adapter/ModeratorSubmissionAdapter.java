...
public class ModeratorSubmissionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_moderator_submission,
                parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof ViewHolder) {
            ...
            holder.owner.setText(mContext.getString(R.string.submitted_by, submission.getOwner().getName()));
