...
public class DestinationTransferSubmissionAdapter extends BaseAdapter {

    private final Context context;
    private List<UserData> users;

    public DestinationTransferSubmissionAdapter(Context context, UserData except, List<UserData> users) {
