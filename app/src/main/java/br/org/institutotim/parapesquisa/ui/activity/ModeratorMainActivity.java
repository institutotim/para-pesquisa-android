...
public class ModeratorMainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.container,
                    new ModeratorFormsFragment()).commitAllowingStateLoss();
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.my_surveys:
                ...
                fragment = Fragment.instantiate(this, ModeratorFormsFragment.class.getName());
                break;
            case R.id.help:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_sync) {
            ...
            startActivity(new Intent(this, GlobalReportActivity.class));
            return true;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (mSelected == R.id.my_surveys) {
            ...
            inflater.inflate(R.menu.moderator_main, menu);
    ...
    void logout() {
        if (notExists(mHelper.getTransfers())
                && notExists(mHelper.getApprovedSubmissions())
                && notExists(mHelper.getRepprovedSubmissions())
                && notExists(mHelper.getPendingSubmissions())) {
    ...
    private boolean notExists(List<?> list) {
